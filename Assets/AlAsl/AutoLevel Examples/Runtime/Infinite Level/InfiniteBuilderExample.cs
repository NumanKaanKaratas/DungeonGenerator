...
namespace AutoLevel.Examples
{
    ...
    public class InfiniteBuilderExample : MonoBehaviour
    {
        ...
        private void OnEnable()
        {
            ...
            for (int d = 0; d < 6; d++)
                if (d != (int)AlaslTools.Direction.Forward)
                    solver.SetGroupBoundary("Solid", (AlaslTools.Direction)d);
        ...
        private void Solve(int pos, Tile tile, Tile preTile)
        {
            ...
            solver.SetBoundary(new LevelBoundary(preTile.leveData, null, null), AlaslTools.Direction.Backward);
